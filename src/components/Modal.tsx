...
const Modal = ({ isOpen = false, onClose, children }: ModalProps) => {
  return (
    ...
    >
      <div className="bg-white relative w-[500px] mx-auto p-10 rounded shadow-xl flex flex-col gap-6 animate-y">
        {children}
        <button
          className="bg-black absolute -right-6 -top-6 text-white  hover:bg-primary py-2 px-4 rounded-full text-4xl"
          onClick={onClose}
